...
export interface SignInSmsPasswordlessHandler {
    (phoneNumber: RefOrValue<string>, options?: NestedRefOfValue<PasswordlessOptions | undefined>): Promise<SignInSmsPasswordlessHandlerResult>;
}
export interface SignInSmsPasswordlessOtpHandler {
    (code: RefOrValue<string>): Promise<SignInSmsPasswordlessOtpHandlerResult>;
    (phoneNumber: RefOrValue<string>, code: RefOrValue<string>): Promise<SignInSmsPasswordlessOtpHandlerResult>;
}
 ...
 */
export declare function useSignInSmsPasswordless(stateOptions?: NestedRefOfValue<PasswordlessOptions | undefined>): SignInSmsPasswordlessComposableResult;
